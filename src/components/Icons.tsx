...
export const Icon: React.FC<IconProps> = ({ icon }) => {
    ...
    return (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" width="32" height="32" strokeWidth="1" strokeLinejoin="round" strokeLinecap="round" stroke="currentColor">
            {paths.map((path, i) => (
